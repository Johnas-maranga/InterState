<%-- 
    Document   : log
    Created on : Oct 7, 2019, 12:19:26 PM
    Author     : twinkle
--%>
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-12">
							<ul class="nav navbar-nav w3_agile_nav">
								...
								<li><a href="mail.html"><span>About Us</span></a></li>
...
<div class="footer-top">
		<div class="container">
				...
				<div class="w3-agileits-subscribe-form">
					<form name="form1" action="logincon.jsp">
                                         
                                            <font color="red">Username: </font><input type="text" name="txt"><label id="lun"></label>
